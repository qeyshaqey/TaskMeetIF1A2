...
<head>
    ...
    <style>
        /* ... (Gunakan style CSS yang mirip dengan file lain) ... */
        body {
            display: flex;
...
<body>
    ...
    <?php else: ?>
        <div style="width: 35%; max-width: 450px; margin: 30px auto; padding: 30px; border: 1px solid #ddd; border-radius: 8px; background-color: white; text-align: center;">
            <img width="150" height="150" src="../admin_side/format_gambar/logo.png" alt="Logo">
            <?php if (!empty($error)): ?>
                <div class="alert alert-danger"><?php echo $error; ?></div>
            <?php endif; ?>
